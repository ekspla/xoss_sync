...
determined by the unresponsive peripheral (no empty packets from XOSS-G+) to the ACKs in YMODEM.  Typically, 2-3 ACKs (2-3 connection events = 15-20 ms) are necessary.
