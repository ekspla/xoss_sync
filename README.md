...
determined by the unresponsive peripheral (i.e. no empty packets from XOSS-G+) to the ACKs in YMODEM.  Typically, 2-4 ACKs (2-4 connection events = 15-30 ms) are necessary.
