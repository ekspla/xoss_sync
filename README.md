...
3. Sync times (throughputs in parentheses) using my FIT file of 235,723 bytes were as followings (as of 6 SEP 2024).
...
; ```CONFIG_FREERTOS_HZ=1000``` (from default value of 100 \[10 ms\] to 1000 Hz \[1 ms\]).
